/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4830d032a9c09db59819b01f61af3b2c)
...
interface __BaseEnv_Env {
	...
	JOB_ROOM: DurableObjectNamespace<import("./src/server").JobRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "JobRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "TEMPORAL_STARTER_SECRET" | "TEMPORAL_STARTER_URL" | "STATUS_WEBHOOK_SECRET">> {}
}
